...
public class wallMonster extends Etaj2_Room1
{
    GifImage monster = new GifImage("objects/wall_monster.gif");
    public GreenfootImage monsterN = new GreenfootImage("objects/wall_monster.png");
    ...
    public void act() 
    {
        ...
        setLocation(getX(), view1.getY()-166);
